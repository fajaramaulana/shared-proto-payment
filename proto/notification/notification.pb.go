...
type NotificationRequest struct {
	...
	Timestamp *datetime.DateTime `protobuf:"bytes,7,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	TypeId    string             `protobuf:"bytes,8,opt,name=type_id,proto3" json:"type_id,omitempty"`
}
...
func (x *NotificationRequest) GetIpAddress() string {
	if x != nil {
		return x.IpAddress
	}
	return ""
...
func (x *NotificationRequest) GetUserAgent() string {
	if x != nil {
		return x.UserAgent
	}
	return ""
...
func (x *NotificationRequest) GetTimestamp() *datetime.DateTime {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *NotificationRequest) GetTypeId() string {
	if x != nil {
		return x.TypeId
	}
	return ""
...
var file_notification_notification_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x82, 0x02, 0x0a, 0x13,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x12, 0x18, 0x0a,
	...
	,
	...
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x42, 0x5a, 0x40, 0x67, 0x69,
...
var file_notification_notification_proto_depIdxs = []int32{
	2, // 0: notification.NotificationRequest.timestamp:type_name -> google.type.DateTime
